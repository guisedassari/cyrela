...
foreach ($clientes as $cliente) {
    $this->table->add_row(
            ...
            $cliente['telefone'], 
            $cliente['newsletter'], 
            anchor("admin/clientes/clientes/edit/{$cliente['id_cliente']}", '<i class="fa fa-pencil-square-o" aria-hidden="true"></i>', array('class' => 'btn btn-azul'))."&nbsp; &nbsp".anchor("admin/clientes/clientes/delete/{$cliente['id_cliente']}/{$cliente['caricatura']}", '<i class="fa fa-trash" aria-hidden="true"></i>', array('class' => 'btn btn-danger'))
             );
}
